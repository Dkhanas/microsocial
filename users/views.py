...
from users.forms import SettingsForm, UserPasswordChangeForm, UserEmailChangeForm, UserWallPostForm, SearchForm
...
class FriendshipApiView(View):
    ...
    def _action_add_to_friends(self):
        ...
        if user:
            try:
                ...
                if r == 1:
                    messages.success(self.request, _(u'Заявка успішно відправлена і очікує розляду'))
                elif r == 2:
                    messages.success(self.request, _(u'Користувач успішно добавлений в друзі'))
                    return 'friends'
        return 'incoming'
    ...
    def _action_approve(self):
        ...
        if user:
            try:
                ...
                if r:
                    messages.success(self.request, _(u'Заявка успішно підтрерджена. Користувач доданий в друзі'))
        return 'incoming'
    ...
    def _action_reject(self):
        ...
        if user:
            ...
            messages.success(self.request, _(u'Заявка успішно відмолено'))
        return 'incoming'
    ...
    def _action_cancel_outcoming(self):
        ...
        if user:
            ...
            messages.success(self.request, _(u'Заявку успішно видалено'))
            return 'outcoming'
    ...
    def _action_delete_from_friends(self):
        ...
        if user:
            if User.friendship.delete(self.request.user, user):
                messages.success(self.request, _(u'Користувача успішно видалено з друзів.'))
        return 'friends'
