...
class NewItemManager(models.Manager):
...
class NewsItem(models.Model):
    ...
    TYPE_CHOICES = (
        (TYPE_WALL_POST, _(u'повідомлення на стіні')),
        (TYPE_MAKE_FRIENDS, _(u'тепер друзі')),
        (TYPE_BREAK_FRIENDS, _(u'розірвали дружбу')),
    )
